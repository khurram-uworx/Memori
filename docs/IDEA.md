...
This lets users configure any `VectorStore` provider (Azure AI Search, Qdrant, etc.) for facts without writing Memori-specific adapters. The `IStorage` interface and `InMemoryStorage` class have been removed.
